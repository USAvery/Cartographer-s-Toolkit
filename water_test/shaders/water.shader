...
void fragment()
{
	vec2 distort1 = (texture(distortion, world_distort_uv - wave_pos * 0.05).rg - 0.5) * 0.005;
	vec2 distort2 = (texture(distortion, world_distort_uv + wave_pos * 0.05).rg - 0.5) * 0.005;
